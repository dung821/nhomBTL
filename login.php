    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xs-offset-3 col-xs-5 col-sm-5 col-md-5 col-lg-5">
          ...
          <form class="form_login form_signUp" action="process-login.php" method="POST">
            ...
            <div class="input mt-3"><input name="txtPass" type="password" placeholder="Mật khẩu*" class="form-control" id="password" /></div>
            ...
            <div class="trochuot" id="trochuot">
              <button class="NextStep" name="btnLogin" type="submit">Đăng Nhập</button>
            </div>
          </form>
          </div>
        </div>
