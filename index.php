...
<!--         
     ...
     <source src="https://niemvuilaptrinh.ams3.cdn.digitaloceanspaces.com/HTML5_video/video_vi_du.mp4" type="video/mp4">
            ...
            <!-- <div  class="row__poster" ><video height="auto" target="_blank" width="340px" src="      <--?php echo $link ?>    " type="/image/phim1.mp4" controls></video></div> -->
            ...
            <div  class="row__poster"><video height="auto" target="_blank" width="340px" src="./image/videobackgroud.mp4" type="video/mp4" controls></video></div>
<br>
        </div>
    </div>
